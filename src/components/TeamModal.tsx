  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-20 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 border border-white/10 flex items-center justify-center text-white transition-colors cursor-pointer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
          {/* Left Column - Member Image and Quick Info */}
          <div className="md:col-span-5 bg-gradient-to-b from-[#181832] to-[#0d0d1a] p-8 flex flex-col items-center text-center justify-between border-b md:border-b-0 md:border-r border-white/10 relative">
            <div className="w-full flex flex-col items-center">
              ...
              <p className="text-sm font-semibold text-[#00f0ff] mt-1">{member.role}</p>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {member.technologies.map((tech, i) => (
                  <span
                    key={i}
                    className="text-xs font-mono font-semibold text-[#00f0ff] bg-[#00f0ff]/10 border border-[#00f0ff]/30 px-3 py-1 rounded-full shadow-sm"
                  >
                    {tech}
                  </span>
                ))}
