...
export function AchievementsSection() {
  ...
  return (
    <section id="conquistas" ref={ref} className="py-24 bg-[#0a0b14] relative">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {DIFFERENTIALS.map((diff, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[#8b5cf6]/10 border border-[#8b5cf6]/30 flex items-center justify-center text-[#a78bfa] mb-4">
